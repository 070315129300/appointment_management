                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            @foreach($user as $users)
                                ...
                                <tr>
                                    ...
                                    <td>{{$users->date}}</td>
                                    <td>{{$users->time}}</td>
                                    <td>{{$users->appointmentreason}}</td>
                                    <td>{{$users->status}}</td>
                                    <td>
                                        <a class="btn btn-success" href="{{url('approved', $user->id)}}">approved</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="{{url('cancelled', $user->id)}}">cancelled</a>
                                    </td>
